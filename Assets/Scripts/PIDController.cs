...
public class PIDController
{
    ...
    // Pass in the value we want and the value we currently have
    // Returns a number that moves us towards our goal (stabilisation)
    public float Seek(float seekValue, float currentValue)
    {
        ...
        // Actual PID formula. Gives us the value that is returned
